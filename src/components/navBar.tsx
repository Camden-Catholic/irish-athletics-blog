...
export default (): JSX.Element => {
  return (
    <Disclosure as="nav" className="bg-CCHSwhite">
      {({ open }) => (
        <>
            ...
            <div className="relative flex h-16 items-center justify-between">
              <div className="absolute inset-y-0 left-0 flex items-center sm:hidden">
                ...
                <Disclosure.Button className="inline-flex items-center justify-center rounded-md p-2 text-gray-400 hover:bg-primary hover:text-white focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white">
                  ...
                  {open ? (
                    ...
                    <img src={Bars3Icon} className="block h-6 w-6" aria-hidden="true" />
                  )}
                </Disclosure.Button>
              </div>
                    ...
                    {navigation.map((item) => (
                      <a
                        ...
                        className={classNames(
                          item.current ? ' text-black' : 'text-black hover:bg-primary hover:text-white',
              ...
              <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                ...
                >
                  ...
                  <img src={BellIcon} className="h-6 w-6" aria-hidden="true" />
                </button>
